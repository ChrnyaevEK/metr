...
export const BASE_API_URL = process.env.NODE_ENV == 'development' ? 'http://localhost:8000/api' : `http://${window.location.host}/api`
export const BASE_WS_URL = process.env.NODE_ENV == 'development' ? 'ws://localhost:8000' : `ws://${window.location.host}`
